...
//       try {
//         const res = await axiosClient.get("/loan/repaidloans");
//         setLoans(res.data);
//       } catch (err) {
...
//               <th className="px-6 py-3 text-left font-semibold">Repaid Date</th>
//             </tr>
//           </thead>
//           <tbody>
//             {loans.length > 0 ? (
...
//                     {new Date(loan.repaidDate).toLocaleDateString("en-GB")}
//                   </td>
//                 </tr>
//               ))
//             ) : (
...
//                 Repaid: {new Date(loan.repaidDate).toLocaleDateString("en-GB")}
//               </p>
//             </div>
//           ))
//         ) : (
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="mx-auto w-full max-w-7xl px-3 py-5 sm:px-6 sm:py-6 lg:px-8">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500 sm:text-base">
                View the complete history of loans that have been repaid.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Summary */}
        <div className="mb-5 rounded-xl border border-emerald-100 bg-emerald-50 p-4 sm:mb-6 sm:rounded-2xl sm:p-5">
                    ...
                    >
                      <div className="flex flex-col items-center">
                        ...
                        <p className="font-medium text-slate-600">
                          No repaid loans found
                        </p>

                        <p className="mt-1 text-sm text-slate-400">
                          There are currently no completed loan repayments.
                        </p>
                      </div>
                    </td>
                  </tr>
