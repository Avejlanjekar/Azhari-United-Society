...
export default function MemberDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-[280px] flex-col border-r border-slate-200 bg-white shadow-xl transition-transform duration-300 ease-in-out md:z-40 md:w-72 md:translate-x-0 md:shadow-sm ${
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 border-t border-slate-200 bg-white/95 px-2 py-2 shadow-[0_-4px_20px_rgba(15,23,42,0.08)] backdrop-blur-md md:hidden">
